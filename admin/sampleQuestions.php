...
.insert_table{}
.maincontent{ margin-left: 52px;margin-top: 25px;margin-bottom: 25px; }
.MC_sms{border: 1px solid;font-size: 17px;height: 42px;margin-bottom: 10px; width:200px;}	
.msg{ margin-left: 252px;}	
.new_button_class{ width: 100px;
    height: 30px;
    border: 1px solid;
    color: black;
    font-size: 15px; margin-top:12px; background:url(../img/insert-text.png) 3px 5px no-repeat, linear-gradient(to bottom, #f7f7f8 0%,#ffffff 100%)}
.new_button_class:hover{border: 1px solid #447314;text-shadow: #31540c 0 1px 0;}	
.new_input_filed{width: 200px;
    height: 28px;
    font-size: 18px;
    border: 1px solid;
    padding-left: 10px; margin-bottom:6px; font-family:"Arial Black";}
.new_input_filed_two{width: 400px;
    height: 28px;
    font-size: 18px;
    border: 1px solid;
    padding-left: 10px; margin-bottom:6px; font-family:"Arial Black";}	
.new_input_filed_one{font-size: 18px; border: 1px solid #000;  margin-bottom:6px; font-weight:bold; padding-left:8px;font-family:"Arial Black";}
						...
						<form method="post" action="insert.php">
							<table class="insert_table" border="0">
                                <tr>
                                    <td>Question No: </td>
                                    <td>
                                        <input type="text" name="qsn_no" placeholder="Question No." title="Put Question No." required="1" class="new_input_filed"><br>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Question :</td>
                                    <td>
                                        ...
                                        <textarea name="qsn"   title="Write Sample Question" required="1" placeholder="Question" rows="5" cols="43" class="new_input_filed_one" ></textarea><br>
                                 ...
                                 <tr>
                                    <td>Answer :</td>
                                    <td>
                                        <input type="text" name="ans" placeholder="Answer" title="Give Your Answer" required="1" class="new_input_filed_two"><br>
                                    </td>
                                </tr>
                                 <tr>
                                    <td></td>
                                    <td>
                                        <input type="submit" name="btn" value="Insert"  class="new_button_class" onclick="displayData(11,1,0,'A')" onmouseover="" style="cursor: pointer;"><br>
                                    </td>
                                </tr>
