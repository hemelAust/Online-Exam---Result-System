...
<title>Edit Sample Questions</title>
</head>
<style  type="text/css">
...
textarea:focus:-moz-placeholder { -moz-animation-duration: 0.4s; -moz-animation-name: slidein; -moz-animation-timing-function: ease-out; -moz-animation-fill-mode: forwards; -moz-animation-delay: 0.1s;}
input:focus:-moz-placeholder { -moz-animation-duration: 0.4s; -moz-animation-name: slidein;  -moz-animation-timing-function: ease-out;
...
.border_{  border: 1px solid #000000;
    ...
    padding-top: 28px;
    padding-left: 20px;
    padding-bottom: 20px;margin-right: 45px;  height: 306px;}
.content_of_border{}
.all_buttons{}
.insert_button{}
...
.new_button_class_one{ width: 100px; text-decoration:none; 
    ...
    color: black;
    font-size: 15px; margin-top:12px; background: url(../img/Update.png) 3px 5px no-repeat, linear-gradient(to bottom, #f7f7f8 0%,#ffffff 100%)}
.new_button_class_one:hover{border: 1px solid #447314;text-shadow: #31540c 0 1px 0;}
.new_button_class_two{ width: 100px; text-decoration:none; 
    height: 30px;
    border: 1px solid; margin-right:15px;
    color: black;
    font-size: 15px; margin-top:12px; background: url(../img/undo_256.png) 3px 5px no-repeat, linear-gradient(to bottom, #f7f7f8 0%,#ffffff 100%)}
.new_button_class_two:hover{border: 1px solid #447314;text-shadow: #31540c 0 1px 0;}
       		...
       		<div class="border_ alignlieft fix">
            	...
            	<div class="content_of_border fix">
                        ...
                        <form method="POST" action="">
                            Select Question No. to Update: <select name="sel" class="drop_down" title="Select Question No. First" >
                        ...
                        <table class="insert_table" border="0">
                                ...
                                <tr>
                                    <td>Question :</td>
                                    <td>
                                        <textarea name="question_" title="Write Sample Question" class="type_"  placeholder="Question" rows="5" cols="30"></textarea><br>
                                    </td>
                                </tr>
                                 <tr>
                                    <td>Answer :</td>
                                    <td>
                                        <input type="text"  placeholder="Answer" title="Give Your Answer"  name="answer_" class="type"><br>
                                    </td>
                                </tr>
                                 <tr>
                                    <td></td>
                                    <td>
                                        <input name="submit" type="submit" value="Update" class="new_button_class_one" onclick="displayData(11,1,0,'A')" onmouseover="" style="cursor: pointer;" />
                        <input name="reset" type="reset" value="Reset" class="new_button_class_two" onclick="displayData(11,1,0,'A')" onmouseover="" style="cursor: pointer;"/>
					...
					{
					$value=$_POST['sel'];
					$question_=$_POST['question_'];
					$answer_=$_POST['answer_'];
					
					
				
					if($question_ && $answer_){
					$query2 = "UPDATE samplequestions SET question_='$question_',answer_='$answer_' WHERE question_no='$value'";
					...
					if($question_){
					$query2 = "UPDATE samplequestions SET question_='$question_' WHERE question_no='$value'";
					$result2=mysql_query($query2) or die("Query Failed : ".mysql_error());
					$_SESSION['msg'] = "Successfully Updated";
					header('location : edit.php');
					}
					...
					if($answer_){
					$query2 = "UPDATE samplequestions SET answer_='$answer_' WHERE question_no='$value'";
					$result2=mysql_query($query2) or die("Query Failed : ".mysql_error());
					$_SESSION['msg'] = "Successfully Updated";
					header('location : edit.php');
					}
